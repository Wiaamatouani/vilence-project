...
import about from "../assets/images/A_Queer_Engagement_Session_in_a_Poppy_Field.jpg"
import Logo from "../assets/images/logo.png"
import home from "../assets/images/women.jpg"
import act from "../assets/images/act.png"
// import Lawaccordin from "../components/lawaccordin";
...
const Home = () => {
  ...
  return (
    <>
      ...
      <section className="py-8 md:py-16 px-4 bg-[#f3f4f6] md:px-6">
                        ...
                        {open === 1 && (
                            <div className="px-4 md:px-6 py-4 bg-[#fcd7c16e] rounded-lg mt-4">
                                <ul className="list-disc list-inside space-y-2">
                                    ...
                                    <li>Blaming the victim for the problems</li>
                                </ul>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="w-full max-w-6xl mx-auto px-4 mt-2">
                        ...
                        {open === 2 && (
                            <div className="px-4 md:px-6 py-4 bg-[#fcd7c16e] rounded-lg mt-4">
                                ...
                                <ul className="list-disc list-inside space-y-2">
                                    <li>Physical and mental health issues
</li>
                                    <li> Economic costs (healthcare, legal services, loss of productivity)</li>
                                    <li>Intergenerational trauma</li>
                                    <li>Social inequality and discrimination</li>
                                </ul>
                            </div>
                        )}
                    </div>
      ...
      {/* Hashtag Section */}
      <div className="flex justify-center overflow-hidden gap-6 md:gap-12 h-[20vh] md:h-[30vh] bg-[#f3f4f6]   items-center">
